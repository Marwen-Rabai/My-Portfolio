...
export const aboutMe = {
  ...
  description: "Marwen Rabai is a visionary serial entrepreneur and Digital Marketing & SEO Strategist with over 14 years of experience building transformative ventures across North Africa and beyond. Founder of Cristi Labs, an innovation-driven technology lab, and Cristi Aura, a next-generation personal branding platform. As Founder & CEO of Uber Sand Food, he pioneered a bold food delivery concept for the North African market, and as Founder & Organizer of the Tunisia Electronic Music Festival (TEMF), he bridges culture, technology, and entertainment on an international stage. His expertise spans SEO, content creation, event production, and brand strategy — anchored by a deep passion for innovation and a relentless commitment to excellence.",
  experience: "14+ years",
